...
- This project uses `babel-plugin-react-compiler` for automatic optimization
- **DO NOT** manually write `useMemo`, `useCallback`, or `React.memo` wrappers
- The React Compiler automatically memoizes components and values as needed
- Focus on writing clear, readable code - let the compiler handle performance optimization
